...
from ..utils import normal_init, bias_init_with_prob, IGCv3_block, Reorder
...
class RetinaHead(nn.Module):
    ...
    def __init__(self,
        ...
        for i in range(self.stacked_convs):
            ...
            self.cls_convs.append(
                nn.Conv2d(chn, feat_channels, 3, stride=1, padding=1, groups=1))
        ...
        if self.head_type == 'thin':
            ...
            #         groups=self.cls_out_channels)
            #     )
            self.retina_cls = Class_predict(feat_channels, self.num_anchors, self.cls_out_channels)
    ...
    def init_weights(self):
        ...
        if self.head_type == 'thin':
            for m in self.retina_cls.modules():
